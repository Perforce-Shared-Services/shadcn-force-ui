/**
 * Calendar 24 block — SINGLE SWAP POINT for the block's own decorative glyph.
 *
 ...
 * upstream registry uses lucide-react's `ChevronDownIcon` on the date-picker
...
/** Trailing glyph on the date-picker trigger button. */
export const CALENDAR_24_CHEVRON_DOWN_SVG = chevronDown;
