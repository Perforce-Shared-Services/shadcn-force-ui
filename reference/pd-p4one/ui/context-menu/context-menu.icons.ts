/**
 * Single swap-point for Context Menu icons.
 *
 ...
 *
 * The registry's `ContextMenuSubTrigger` chevron is NOT mapped here — submenus
...
export const CONTEXT_MENU_INDICATOR_SVG = check;
