...
@Component({
  ...
  template: `<div class="flex w-full max-w-md flex-col gap-6" dir="rtl">
    <div uiItem variant="outline" dir="rtl">
      <div uiItemContent>
        <div uiItemTitle>عنصر أساسي</div>
        <p uiItemDescription>عنصر بسيط يحتوي على عنوان ووصف.</p>
      </div>
      <div uiItemActions>
        <button uiButton variant="outline" size="sm">إجراء</button>
      </div>
    </div>
    <a uiItem variant="outline" size="sm" href="#" dir="rtl">
      <div uiItemMedia>
        <svg
          aria-hidden="true"
      ...
      <div uiItemContent>
        <div uiItemTitle>تم التحقق من ملفك الشخصي.</div>
      </div>
      <div uiItemActions>
        <svg
          aria-hidden="true"
...
export class ItemRtlComponent {}

export default ItemRtlComponent
