...
We've added new components to Force UI and made a lot of improvements to the CLI.
...
Another one by [emilkowalski](https://twitter.com/emilkowalski). The last toast component you'll ever need. Sonner is now available in Force UI.
...
This means you can now easily add Force UI components to existing projects like Docusaurus, Nextra...etc. A drop-in for your existing design system with no conflict.
