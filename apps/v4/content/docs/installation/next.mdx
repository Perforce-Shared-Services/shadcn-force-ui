---
title: Next.js
description: Install and configure Force UI for Next.js.
---
...
<div className="mt-6 grid gap-4 sm:grid-cols-3 sm:gap-6">
  ...
  >
    ...
    <div className="leading-relaxed text-muted-foreground">
      Configure Force UI manually in an existing Next.js project.
    </div>
  </LinkedCard>
</div>
...
If you're adding Force UI to an older or custom Next.js app, make sure Tailwind CSS is installed first. You can follow the official [Next.js installation guide](https://nextjs.org/docs/app/getting-started).
