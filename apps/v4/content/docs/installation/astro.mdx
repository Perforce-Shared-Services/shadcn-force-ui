---
title: Astro
description: Install and configure Force UI for Astro.
---
...
<div className="mt-6 grid gap-4 sm:grid-cols-3 sm:gap-6">
  ...
  >
    ...
    <div className="leading-relaxed text-muted-foreground">
      Configure Force UI manually in an existing Astro project.
    </div>
  </LinkedCard>
</div>
...
This command sets up Tailwind CSS and the React integration for you. If you're adding Force UI to an older or custom Astro app, make sure both are configured before continuing.
