...
<ComponentPreview styleName="base-force-ui" name="sheet-demo" />
...
<ComponentPreview styleName="base-force-ui" name="sheet-side" />

## No Close Button

Use `showCloseButton={false}` on `SheetContent` to hide the close button.

<ComponentPreview styleName="base-force-ui" name="sheet-no-close-button" />

## RTL

To enable RTL support in Force UI, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-force-ui" name="sheet-rtl" direction="rtl" />
