...
<ComponentPreview styleName="base-force-ui" name="popover-demo" />
...
<ComponentPreview styleName="base-force-ui" name="popover-basic" />

## Align

Use the `align` prop on `PopoverContent` to control the horizontal alignment.

<ComponentPreview styleName="base-force-ui" name="popover-alignments" />

## With Form

A popover with form fields inside.

<ComponentPreview styleName="base-force-ui" name="popover-form" />
