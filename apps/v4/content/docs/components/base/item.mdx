...
<ComponentPreview styleName="base-force-ui" name="item-demo" />
...
<ComponentPreview styleName="base-force-ui" name="item-icon" />

## Avatar

You can use `ItemMedia` with `variant="avatar"` to display an avatar.

<ComponentPreview styleName="base-force-ui" name="item-avatar" />

## Image

Use `ItemMedia` with `variant="image"` to display an image.

<ComponentPreview styleName="base-force-ui" name="item-image" />
...
<ComponentPreview styleName="base-force-ui" name="item-link" />
...
<ComponentPreview styleName="base-force-ui" name="item-dropdown" />

## RTL

To enable RTL support in Force UI, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-force-ui" name="item-rtl" direction="rtl" />
