...
<ComponentPreview styleName="base-force-ui" name="progress-demo" />
...
<ComponentPreview styleName="base-force-ui" name="progress-label" />

## Controlled

A progress bar that can be controlled by a slider.

<ComponentPreview styleName="base-force-ui" name="progress-controlled" />
