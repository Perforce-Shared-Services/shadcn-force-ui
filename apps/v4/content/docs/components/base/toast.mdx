...
<ComponentPreview styleName="base-force-ui" name="toast-demo" />
...
<ComponentPreview styleName="base-force-ui" name="toast-types" />
...
<ComponentPreview styleName="base-force-ui" name="toast-promise" />
