...
<ComponentPreview styleName="base-force-ui" name="badge-demo" />
...
<ComponentPreview styleName="base-force-ui" name="badge-variants" />

### Status Variants

<ComponentPreview styleName="base-force-ui" name="badge-status" />

## With Icon

You can render an icon inside the badge. Use `data-icon="inline-start"` to render the icon on the left and `data-icon="inline-end"` to render the icon on the right.

<ComponentPreview styleName="base-force-ui" name="badge-icon" />
...
<ComponentPreview styleName="base-force-ui" name="badge-spinner" />

## Link

Use the `render` prop to render a link as a badge.

<ComponentPreview styleName="base-force-ui" name="badge-link" />

### Solid Status Variants

Use solid variants for maximum-attention states like critical counts or overdue flags.

<ComponentPreview styleName="base-force-ui" name="badge-solid" />

## Custom Colors

You can customize the colors of a badge by adding custom classes such as `bg-green-50 dark:bg-green-800` to the `Badge` component.

<ComponentPreview styleName="base-force-ui" name="badge-colors" />

## RTL

To enable RTL support in Force UI, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-force-ui" name="badge-rtl" direction="rtl" />
