...
<ComponentPreview styleName="base-force-ui" name="menubar-demo" />
...
<ComponentPreview styleName="base-force-ui" name="menubar-checkbox" />

## Radio

Use `MenubarRadioGroup` and `MenubarRadioItem` for single-select options.

<ComponentPreview styleName="base-force-ui" name="menubar-radio" />

## Submenu

Use `MenubarSub`, `MenubarSubTrigger`, and `MenubarSubContent` for nested menus.

<ComponentPreview styleName="base-force-ui" name="menubar-submenu" />

## With Icons

<ComponentPreview styleName="base-force-ui" name="menubar-icons" />
