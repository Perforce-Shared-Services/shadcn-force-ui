...
<ComponentPreview styleName="base-force-ui" name="date-picker-demo" />
...
<ComponentPreview styleName="base-force-ui" name="date-picker-basic" />

## Range Picker

A date picker component for selecting a range of dates.

<ComponentPreview styleName="base-force-ui" name="date-picker-range" />
...
<ComponentPreview styleName="base-force-ui" name="date-picker-dob" />

## Input

A date picker component with an input field for selecting a date.

<ComponentPreview styleName="base-force-ui" name="date-picker-input" />

## Time Picker

A date picker component with a time input field for selecting a time.

<ComponentPreview styleName="base-force-ui" name="date-picker-time" />
