...
<ComponentPreview styleName="base-force-ui" name="checkbox-invalid" />

## Basic

Pair the checkbox with `Field` and `FieldLabel` for proper layout and labeling.

<ComponentPreview styleName="base-force-ui" name="checkbox-basic" />

## Description

Use `FieldContent` and `FieldDescription` for helper text.

<ComponentPreview styleName="base-force-ui" name="checkbox-description" />

## Disabled

Use the `disabled` prop to prevent interaction and add the `data-disabled` attribute to the `<Field>` component for disabled styles.

<ComponentPreview styleName="base-force-ui" name="checkbox-disabled" />

## Group

Use multiple fields to create a checkbox list.

<ComponentPreview styleName="base-force-ui" name="checkbox-group" />
