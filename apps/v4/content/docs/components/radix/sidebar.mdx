...
import { ExternalLinkIcon } from "@/examples/material-symbols"
...
```bash
npx shadcn@latest add @force-ui/sidebar
```
...
<Button asChild size="sm" className="mt-6">
  <a href="/view/radix-force-ui/sidebar-rtl" target="_blank">View RTL Sidebar <ExternalLinkIcon /></a>
</Button>
