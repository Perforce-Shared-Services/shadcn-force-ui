...
<ComponentPreview styleName="radix-force-ui" name="menubar-demo" />
...
```bash
npx shadcn@latest add @force-ui/menubar
```
...
<ComponentPreview styleName="radix-force-ui" name="menubar-checkbox" />

## Radio

Use `MenubarRadioGroup` and `MenubarRadioItem` for single-select options.

<ComponentPreview styleName="radix-force-ui" name="menubar-radio" />

## Submenu

Use `MenubarSub`, `MenubarSubTrigger`, and `MenubarSubContent` for nested menus.

<ComponentPreview styleName="radix-force-ui" name="menubar-submenu" />

## With Icons

<ComponentPreview styleName="radix-force-ui" name="menubar-icons" />
