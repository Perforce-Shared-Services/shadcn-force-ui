...
<ComponentPreview name="aspect-ratio-demo" styleName="radix-force-ui" />
...
```bash
npx shadcn@latest add @force-ui/aspect-ratio
```
...
<ComponentPreview name="aspect-ratio-square" styleName="radix-force-ui" />
