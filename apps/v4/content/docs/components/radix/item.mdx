...
<ComponentPreview styleName="radix-force-ui" name="item-demo" />
...
```bash
npx shadcn@latest add @force-ui/item
```
...
<ComponentPreview styleName="radix-force-ui" name="item-icon" />

## Avatar

You can use `ItemMedia` with `variant="avatar"` to display an avatar.

<ComponentPreview styleName="radix-force-ui" name="item-avatar" />

## Image

Use `ItemMedia` with `variant="image"` to display an image.

<ComponentPreview styleName="radix-force-ui" name="item-image" />
...
<ComponentPreview styleName="radix-force-ui" name="item-link" />
...
<ComponentPreview styleName="radix-force-ui" name="item-dropdown" />

## RTL

To enable RTL support in Force UI, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="radix-force-ui" name="item-rtl" direction="rtl" />
