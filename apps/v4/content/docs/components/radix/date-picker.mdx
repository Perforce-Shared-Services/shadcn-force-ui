...
<ComponentPreview styleName="radix-force-ui" name="date-picker-demo" />
...
import CalendarIcon from "@material-symbols/svg-400/rounded/calendar_month.svg?react"
...
<ComponentPreview styleName="radix-force-ui" name="date-picker-basic" />

## Range Picker

A date picker component for selecting a range of dates.

<ComponentPreview styleName="radix-force-ui" name="date-picker-range" />
...
<ComponentPreview styleName="radix-force-ui" name="date-picker-dob" />

## Input

A date picker component with an input field for selecting a date.

<ComponentPreview styleName="radix-force-ui" name="date-picker-input" />

## Time Picker

A date picker component with a time input field for selecting a time.

<ComponentPreview styleName="radix-force-ui" name="date-picker-time" />
