...
<ComponentPreview styleName="radix-force-ui" name="toggle-group-demo" />
...
```bash
npx shadcn@latest add @force-ui/toggle-group
```
...
<ComponentPreview styleName="radix-force-ui" name="toggle-group-outline" />

## Size

Use the `size` prop to change the size of the toggle group.

<ComponentPreview styleName="radix-force-ui" name="toggle-group-sizes" />

## Spacing

Use `spacing` to add spacing between toggle group items.

<ComponentPreview styleName="radix-force-ui" name="toggle-group-spacing" />

## Vertical

Use `orientation="vertical"` for vertical toggle groups.

<ComponentPreview styleName="radix-force-ui" name="toggle-group-vertical" />

## Disabled

<ComponentPreview styleName="radix-force-ui" name="toggle-group-disabled" />
