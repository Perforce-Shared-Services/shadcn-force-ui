...
<ComponentPreview styleName="radix-force-ui" name="select-demo" />
...
<ComponentPreview styleName="radix-force-ui" name="select-align-item" />

## Groups

Use `SelectGroup`, `SelectLabel`, and `SelectSeparator` to organize items.

<ComponentPreview styleName="radix-force-ui" name="select-groups" />

## Scrollable

A select with many items that scrolls.

<ComponentPreview styleName="radix-force-ui" name="select-scrollable" />

## Disabled

<ComponentPreview styleName="radix-force-ui" name="select-disabled" />
...
<ComponentPreview styleName="radix-force-ui" name="select-invalid" />
