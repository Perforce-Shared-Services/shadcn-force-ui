...
```bash
npx shadcn@latest add @force-ui/carousel
```
...
<ComponentPreview styleName="radix-force-ui" name="carousel-size" />
...
<ComponentPreview styleName="radix-force-ui" name="carousel-spacing" />
