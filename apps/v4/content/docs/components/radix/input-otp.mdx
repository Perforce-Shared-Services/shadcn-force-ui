...
<ComponentPreview styleName="radix-force-ui" name="input-otp-demo" />
...
```bash
npx shadcn@latest add @force-ui/input-otp
```
...
<ComponentPreview styleName="radix-force-ui" name="input-otp-pattern" />

## Separator

Use the `<InputOTPSeparator />` component to add a separator between input groups.

<ComponentPreview styleName="radix-force-ui" name="input-otp-separator" />

## Disabled

Use the `disabled` prop to disable the input.

<ComponentPreview styleName="radix-force-ui" name="input-otp-disabled" />

## Controlled

Use the `value` and `onChange` props to control the input value.

<ComponentPreview styleName="radix-force-ui" name="input-otp-controlled" />

## Invalid

Use `aria-invalid` on the slots to show an error state.

<ComponentPreview styleName="radix-force-ui" name="input-otp-invalid" />

## Four Digits

A common pattern for PIN codes. This uses the `pattern={REGEXP_ONLY_DIGITS}` prop.

<ComponentPreview styleName="radix-force-ui" name="input-otp-four-digits" />

## Alphanumeric

Use `REGEXP_ONLY_DIGITS_AND_CHARS` to accept both letters and numbers.

<ComponentPreview styleName="radix-force-ui" name="input-otp-alphanumeric" />
