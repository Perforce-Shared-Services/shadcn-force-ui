...
<ComponentPreview styleName="radix-force-ui" name="popover-demo" />
...
```bash
npx shadcn@latest add @force-ui/popover
```
...
<ComponentPreview styleName="radix-force-ui" name="popover-basic" />

## Align

Use the `align` prop on `PopoverContent` to control the horizontal alignment.

<ComponentPreview styleName="radix-force-ui" name="popover-alignments" />

## With Form

A popover with form fields inside.

<ComponentPreview styleName="radix-force-ui" name="popover-form" />
