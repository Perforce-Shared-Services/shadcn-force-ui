...
```bash
npx shadcn@latest add @force-ui/breadcrumb
```
...
<ComponentPreview styleName="radix-force-ui" name="breadcrumb-basic" />

## Custom separator

Use a custom component as `children` for `<BreadcrumbSeparator />` to create a custom separator.

<ComponentPreview styleName="radix-force-ui" name="breadcrumb-separator" />

## Dropdown

You can compose `<BreadcrumbItem />` with a `<DropdownMenu />` to create a dropdown in the breadcrumb.

<ComponentPreview styleName="radix-force-ui" name="breadcrumb-dropdown" />
...
<ComponentPreview styleName="radix-force-ui" name="breadcrumb-link" />
