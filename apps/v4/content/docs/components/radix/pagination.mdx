...
<ComponentPreview styleName="radix-force-ui" name="pagination-demo" />
...
```bash
npx shadcn@latest add @force-ui/pagination
```
...
<ComponentPreview styleName="radix-force-ui" name="pagination-simple" />

## Icons Only

Use just the previous and next buttons without page numbers. This is useful for data tables with a rows per page selector.

<ComponentPreview styleName="radix-force-ui" name="pagination-icons-only" />
