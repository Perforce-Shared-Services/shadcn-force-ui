...
<ComponentPreview styleName="radix-force-ui" name="progress-demo" />
...
```bash
npx shadcn@latest add @force-ui/progress
```
...
<ComponentPreview styleName="radix-force-ui" name="progress-label" />

## Controlled

A progress bar that can be controlled by a slider.

<ComponentPreview styleName="radix-force-ui" name="progress-controlled" />
