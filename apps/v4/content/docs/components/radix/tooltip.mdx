...
<ComponentPreview styleName="radix-force-ui" name="tooltip-demo" />
...
```bash
npx shadcn@latest add @force-ui/tooltip
```
...
<ComponentPreview styleName="radix-force-ui" name="tooltip-sides" />

## With Keyboard Shortcut

<ComponentPreview styleName="radix-force-ui" name="tooltip-keyboard" />

## Disabled Button

Show a tooltip on a disabled button by wrapping it with a span.

<ComponentPreview styleName="radix-force-ui" name="tooltip-disabled" />
