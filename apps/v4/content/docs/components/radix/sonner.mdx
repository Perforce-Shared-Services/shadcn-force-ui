...
<ComponentPreview styleName="radix-force-ui" name="sonner-demo" />
...
```bash
npx shadcn@latest add @force-ui/sonner
```
...
<ComponentPreview styleName="radix-force-ui" name="sonner-types" />

## Description

<ComponentPreview styleName="radix-force-ui" name="sonner-description" />

## Position

Use the `position` prop to change the position of the toast.

<ComponentPreview styleName="radix-force-ui" name="sonner-position" />
