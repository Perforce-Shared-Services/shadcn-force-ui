...
```bash
npx shadcn@latest add @force-ui/field
```
...
<ComponentPreview styleName="radix-force-ui" name="field-input" />

## Textarea

<ComponentPreview styleName="radix-force-ui" name="field-textarea" />

## Select

<ComponentPreview styleName="radix-force-ui" name="field-select" />

## Slider

<ComponentPreview styleName="radix-force-ui" name="field-slider" />

## Fieldset

<ComponentPreview styleName="radix-force-ui" name="field-fieldset" />
...
<ComponentPreview styleName="radix-force-ui" name="field-radio" />

## Switch

<ComponentPreview styleName="radix-force-ui" name="field-switch" />

## Choice Card

Wrap `Field` components inside `FieldLabel` to create selectable field groups. This works with `RadioItem`, `Checkbox` and `Switch` components.

<ComponentPreview styleName="radix-force-ui" name="field-choice-card" />
