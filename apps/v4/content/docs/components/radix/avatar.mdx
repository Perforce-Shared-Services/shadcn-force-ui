...
<ComponentPreview styleName="radix-force-ui" name="avatar-demo" />
...
<ComponentSource styleName="radix-force-ui"
  name="avatar"
...
<ComponentPreview styleName="radix-force-ui" name="avatar-basic" />

## Badge

Use the `AvatarBadge` component to add a badge to the avatar. The badge is positioned at the bottom right of the avatar.

<ComponentPreview styleName="radix-force-ui" name="avatar-badge" />
...
<ComponentPreview styleName="radix-force-ui" name="avatar-dropdown" />
