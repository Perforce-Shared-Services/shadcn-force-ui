...
<ComponentPreview styleName="aria-force-ui" name="checkbox-invalid" />

## Basic

Pair the checkbox with `Field` and `FieldLabel` for proper layout and labeling.

<ComponentPreview styleName="aria-force-ui" name="checkbox-basic" />

## Description

Use `FieldContent` and `FieldDescription` for helper text.

<ComponentPreview styleName="aria-force-ui" name="checkbox-description" />
...
<ComponentPreview styleName="aria-force-ui" name="checkbox-disabled" />

## Group

Use multiple fields to create a checkbox list.

<ComponentPreview styleName="aria-force-ui" name="checkbox-group" />
