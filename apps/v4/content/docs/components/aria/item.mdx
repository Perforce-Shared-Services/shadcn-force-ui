...
<ComponentPreview styleName="aria-force-ui" name="item-demo" />
...
<ComponentPreview styleName="aria-force-ui" name="item-icon" />

## Avatar

You can use `ItemMedia` with `variant="avatar"` to display an avatar.

<ComponentPreview styleName="aria-force-ui" name="item-avatar" />

## Image

Use `ItemMedia` with `variant="image"` to display an image.

<ComponentPreview styleName="aria-force-ui" name="item-image" />
...
<ComponentPreview styleName="aria-force-ui" name="item-link" />
...
<ComponentPreview styleName="aria-force-ui" name="item-dropdown" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="aria-force-ui" name="item-rtl" direction="rtl" />
