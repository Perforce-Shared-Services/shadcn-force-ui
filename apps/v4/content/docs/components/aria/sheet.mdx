...
<ComponentPreview styleName="aria-force-ui" name="sheet-demo" />
...
<ComponentPreview styleName="aria-force-ui" name="sheet-side" />

## No Close Button

Use `showCloseButton={false}` on `SheetContent` to hide the close button.

<ComponentPreview styleName="aria-force-ui" name="sheet-no-close-button" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="aria-force-ui" name="sheet-rtl" direction="rtl" />
