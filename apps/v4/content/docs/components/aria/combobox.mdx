...
<ComponentPreview styleName="aria-force-ui" name="combobox-basic" />

## Multiple

A combobox with multiple selection using `multiple` and `ComboboxChips`.

<ComponentPreview styleName="aria-force-ui" name="combobox-multiple" />

## Clear Button

Use the `showClear` prop to show a clear button.

<ComponentPreview styleName="aria-force-ui" name="combobox-clear" />

## Groups

Use `ComboboxGroup` and `ComboboxSeparator` to group items.

<ComponentPreview styleName="aria-force-ui" name="combobox-groups" />

## Custom Items

You can render custom component inside `ComboboxItem`.

<ComponentPreview styleName="aria-force-ui" name="combobox-custom" />

## Invalid

Use the `isInvalid` prop to make the combobox invalid.

<ComponentPreview styleName="aria-force-ui" name="combobox-invalid" />

## Disabled

Use the `isDisabled` prop to disable the combobox.

<ComponentPreview styleName="aria-force-ui" name="combobox-disabled" />

## Input Group

You can add an addon to the combobox by using the `InputGroupAddon` component inside the `ComboboxInput`.

<ComponentPreview styleName="aria-force-ui" name="combobox-input-group" />
