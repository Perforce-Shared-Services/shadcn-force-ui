...
<ComponentPreview styleName="aria-force-ui" name="pagination-demo" />
...
<ComponentPreview styleName="aria-force-ui" name="pagination-simple" />

## Icons Only

Use just the previous and next buttons without page numbers. This is useful for data tables with a rows per page selector.

<ComponentPreview styleName="aria-force-ui" name="pagination-icons-only" />
...
<ComponentPreview styleName="aria-force-ui" name="pagination-rtl" direction="rtl" />
