...
<ComponentPreview styleName="aria-force-ui" name="progress-demo" />
...
<ComponentPreview styleName="aria-force-ui" name="progress-label" />

## Controlled

A progress bar that can be controlled by a slider.

<ComponentPreview styleName="aria-force-ui" name="progress-controlled" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="aria-force-ui" name="progress-rtl" direction="rtl" />
