...
<ComponentPreview styleName="aria-force-ui" name="tabs-line" />

## Vertical

Use `orientation="vertical"` for vertical tabs.

<ComponentPreview styleName="aria-force-ui" name="tabs-vertical" />

## Disabled

<ComponentPreview styleName="aria-force-ui" name="tabs-disabled" />

## Icons

<ComponentPreview styleName="aria-force-ui" name="tabs-icons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="aria-force-ui" name="tabs-rtl" direction="rtl" />
