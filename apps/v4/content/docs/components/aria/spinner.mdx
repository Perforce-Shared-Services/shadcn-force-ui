...
<ComponentPreview styleName="aria-force-ui" name="spinner-demo" />
...
<ComponentPreview styleName="aria-force-ui" name="spinner-custom" />
...
<ComponentPreview styleName="aria-force-ui" name="spinner-size" />
...
<ComponentPreview styleName="aria-force-ui" name="spinner-button" />
...
<ComponentPreview styleName="aria-force-ui" name="spinner-badge" />

## Input Group

<ComponentPreview styleName="aria-force-ui" name="spinner-input-group" />

## Empty

<ComponentPreview styleName="aria-force-ui" name="spinner-empty" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="aria-force-ui" name="spinner-rtl" direction="rtl" />
