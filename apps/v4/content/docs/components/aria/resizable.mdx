...
<ComponentPreview styleName="aria-force-ui" name="resizable-vertical" />

## Handle

Use the `withHandle` prop on `ResizableHandle` to show a visible handle.

<ComponentPreview styleName="aria-force-ui" name="resizable-handle" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="aria-force-ui" name="resizable-rtl" direction="rtl" />
