    ...
    <Example title="Scrollable Content" className="items-center justify-center">
      <DialogTrigger>
        ...
        <Dialog>
          ...
          <div className="style-vega:-mx-6 style-vega:px-6 style-nova:-mx-4 style-nova:px-4 style-lyra:-mx-4 style-lyra:px-4 style-maia:-mx-6 style-maia:px-6 style-mira:-mx-4 style-mira:px-4 style-luma:-mx-6 style-luma:px-6 style-rhea:-mx-6 style-rhea:px-6 no-scrollbar max-h-[70vh] overflow-y-auto">
